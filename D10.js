...
*/
/* let min = parseInt(prompt('inserisci un valore'));
let max = parseInt(prompt('inserisci un valore'));

function whoIsBigger(min, max){
  if(min < max){
    console.log('Il primo numero ' + min + ' è minore rispetto a ' + max);
  }else{
    console.log('Il primo numero ' + min + ' è maggiore rispetto a ' + max);
  }
}
whoIsBigger(min,max); */
...
/* let str1 = prompt('inserisci una frase');

function deleteOne(str1, bol){
  if(bol === true){
...
*/
/* let str2 = prompt('inserisci una frase');
...
function howManyDays(n){
  ...
  console.log(day)
  if (n>day){
   console.log("i giorni trascorsi dalla data da lei inserita: "+ n + " sono: " + (n-day))
  }
  else{
    console.log("i giorni trascorsi dalla data da lei inserita: "+ n + " sono: " + (day-n))
  }
}
howManyDays(20)
 */
...
let str = prompt('inserisci un valore')
function deleteProp(){
  if(persona.age === str){
    delete persona.age;
  }
...
/* let title = prompt("inserisci il titolo")
let result = []
...
/* function bgRedAhref(){
  ...
  for(let i=0; i<arrLink.length; i++){
    arrLink[i].style.backgroundColor= 'red';
    console.log(arrLink);
  }
}
bgRedAhref(); */
